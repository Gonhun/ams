...
function loadDdMerk() {
    var i = 0;
    $.ajax({
        url: urlPath + '/itsm/api/merkaset/get',
        cache: false,
        method: "POST",
        contentType: "application/json; charset=utf-8",
        complete: function (res) {
...
function loadNrp() {
    if ($("#txtNikEmp").val() == "") {
        ...
        var i = 0;
        $.ajax({
            url: urlPath + '/itsm/api/aset/get/emp',
            cache: false,
...
function getGraphStatus() {
    ...
    var barData = {}
    $.ajax({
        url: urlPath + "/itsm/api/aset/get/graph/status",
        type: 'POST',
        dataType: "json",
        cache: false,
        data: JSON.stringify({
...
$('#tblAset tbody').on('click', '#btnDelete', function () {
    ...
    $.ajax({
        url: urlPath + "/itsm/api/aset/delete",
        method: "POST",
        dataType: "json",
        cache: false,
...
function Save() {
    ...
    if ($("#flagSave").val() == "INSERT") {
        $.ajax({
            url: urlPath + "/itsm/api/aset/insert",
            cache: false,
            method: "POST",
            data: formData,
            //contentType: "application/json; charset=utf-8",
        ...
        $.ajax({
            url: urlPath + "/itsm/api/aset/update",
            cache: false,
            method: "POST",
            data: formData,
            //contentType: "application/json; charset=utf-8",
